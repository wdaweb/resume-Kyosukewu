...
<div class="mainbox row col-12 g-1">
    ...
    <div class="main full text-center col-12">
        <div class="title h3"><span class='addbtn float-start btn btn-warning' onclick="op('#cover','#content','modal/add.php?do=<?= $do; ?>&t=re_pro')">新增內容</span>
            <nav>
                                ...
                                <tr>
                                    <form action="api/edit.php" method="post">
                                        ...
                                        <td>
                                            ...
                                            if ($key != 0) {
                                            ?>
                                                <button class="btn btn-outline-secondary" onclick="sw(<?= $value['id']; ?>,<?= $sk[$key - 1]['id']; ?>,'re_pro')">往上</button>
                                            <?php
                                            }
                                            if ($key != count($sk) - 1) {
                                            ?>
                                                <button class="btn btn-outline-secondary" onclick="sw(<?= $value['id']; ?>,<?= $sk[$key + 1]['id']; ?>,'re_pro')">往下</button>
                                            <?php
                                            }
                                            ?>
                                        </td>
