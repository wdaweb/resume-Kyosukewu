...
?>
    <div class="d-flex align-items-center col-12 pt-2">
        ...
        <div class="d-flex align-items-center col-3">
            ...
            <div class="col-4"><input type="checkbox" name="show" onclick="api2('display2','re_skills',<?= $value['id']; ?>,'g')" <?= ($value['sh'] == 1) ? "checked" : ""; ?>><?= ($value['sh'] == 1) ? "顯示" : "隱藏"; ?></div>
            <div class="col-4"><button class="btn btn-outline-danger" onclick="api2('del','re_skills',<?= $value['id']; ?>,'g')">刪除</button></div>
        </div>
    </div>
<?php
}
