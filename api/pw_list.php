    ...
    <div class="proitem col-12 border-top pt-2">
        ...
        <div class="col-12 mb-5">
            ...
            <div class="d-flex align-items-center col-12">
                ...
                <div class="col-1"><input type="checkbox" name="show" onclick="api2('display2','re_pro',<?= $value['id']; ?>,'pw')" <?= ($value['sh'] == 1) ? "checked" : ""; ?>><?= ($value['sh'] == 1) ? "顯示" : "隱藏"; ?></div>
                <div class="col-1"><button class="btn btn-outline-danger" onclick="api2('del','re_pro',<?= $value['id']; ?>,'pw')">刪除</button></div>
            </div>
        </div>
    </div>
<?php
